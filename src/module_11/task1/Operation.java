...
class Operation {
    ...
    public static int trySquareRectangle(int a, int b) throws Exception {
        try {
...
// IllegalArgumentException if at least one of its arguments is negative.

// Create trySquareRectangle method which takes two parameters and calls
// squareRectangle to evaluate an area of a rectangle. Catch exceptions that can
// be generated.
